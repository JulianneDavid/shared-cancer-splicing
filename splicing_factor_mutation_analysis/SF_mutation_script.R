...
ggsave(filename = "fig_s1e.pdf", plot = fig_s1e, device = "pdf", width = 178, height = 89, units = "mm")
...
ggsave(filename = "fig_s1f.pdf", plot = fig_s1f, device = "pdf", width = 178, height = 89, units = "in")
